...
public class CloudscapeDataAccess 
   ...
   public CloudscapeDataAccess() throws Exception
   {
      ...
      sqlFind = connection.prepareStatement(
         "SELECT names.personID, firstName, lastName, " +
            "addressID, address1, address2, cityOrTown, county, " +
           "phoneID, phoneNumber, emailID, emailAddress, "
                 + "sec_address1, sec_address2, sec_cityOrTown, sec_county," +
                 " secondary_phoneNo, secondary_Email " +
         ...
         "WHERE lastName = ? AND " +
            ...
            "names.personID = emailAddresses.personID" );/* "zipcode, */
   ...
   private void connect() throws Exception
   {
      ...
      // connect to database
      //connection = DriverManager.getConnection(url, "root", "Poopers92!");
      connection = DriverManager.getConnection( url, "root", "Poopers92!" );
   ...
   {
      //Create dynamic array that can grow as it is filled
      List<AddressBookEntry> dataList = new ArrayList();
      //AddressBookEntry myPerson = new AddressBookEntry();
      ...
      try {
         ...
         //Keep going through the data until te end is reached
         while( resultSet.next() ) {
            ...
            person.setCityOrTown(resultSet.getString(7));
            ...
            person.setAddress1_sec(resultSet.getString(13));
            person.setAddress2_sec(resultSet.getString(14));
            person.setCityOrTown_sec(resultSet.getString(15));//17
            person.setCounty_sec(resultSet.getString(16));//18

            person.setPhoneNumber_sec(resultSet.getString(17));
            person.setEmailAddress_sec(resultSet.getString(18));
            //Add person element to the array list
            dataList.add(person);
         }
      ...
      throws DataAccessException
   {
      ...
      try {
         ...
         sqlUpdateAddress.setString( 3, person.getCityOrTown() );
         sqlUpdateAddress.setString( 4, person.getCounty() );
         sqlUpdateAddress.setString( 5, person.getAddress1_sec() );
         sqlUpdateAddress.setString( 6, person.getAddress2_sec() );
         sqlUpdateAddress.setString( 7, person.getCityOrTown_sec() );
         sqlUpdateAddress.setString( 8, person.getCounty_sec() );
         ...
         sqlUpdatePhone.setString( 2, person.getPhoneNumber_sec() );
         ...
         sqlUpdateEmail.setString( 2, person.getEmailAddress_sec() );
